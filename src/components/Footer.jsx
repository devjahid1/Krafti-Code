      ...
      <div className="site-container grid gap-12 lg:grid-cols-[minmax(16rem,19.6875rem)_1fr] lg:gap-[11.5%]">
        ...
        <div>
          <img
            src={assets.logo}
            alt="Krafti Code"
            className="w-24 sm:w-[7.5rem]"
            width="120"
            height="113"
          />

          <p className="mt-7 text-base leading-8 text-[#b1adad] sm:text-[17px]">
            Turning your ideas into powerful digital experiences with modern
            design, clean development, and lasting impact.
          </p>
        ...
        <div className="grid gap-10 sm:grid-cols-2 xl:grid-cols-4">
          ...
          {columns.map(([title, links]) => (
            <div key={title}>
              <h2 className="mb-7 text-[16px] font-semibold leading-6 text-[#9ea6ad]">
                {title}
              </h2>
          ...
          <address className="not-italic">
            ...
            <ul className="space-y-4 text-[16px] leading-6 text-white">
              <li>
                <a
                  href="mailto:hello@krafticode.com"
                  className="transition hover:text-[#b38ff9]"
                >
